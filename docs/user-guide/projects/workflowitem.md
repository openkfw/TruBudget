...
![view workflowitem details](./../img/view_details_workflowitem.jpg)
...
![create workflowitem](./../img/create_workflowitem.jpg)
...
![create workflowitem](./../img/create_workflowitem_dialog.jpg)
...
![upload document](./../img/upload_document.jpg)
...
![enter "edit"-mode](./../img/enter_edit_mode.jpg)
...
![update workflowitems preview](./../img/update_workflowitems_preview.jpg)
...
![close workflowitem](./../img/close_workflowitem.jpg)
...
2. Navigate to the "History" tab
   ![view the history tab](./../img/history_tab.jpg)
...
4. To filter the history events, click on the expandable filter area and set the filter options
   ![filter workflowitem history](./../img/filter_workflowitem_history.jpg)
...
2. Navigate to the "Documents" tab
   ![view the documents tab](./../img/documents_tab.jpg)
3. If you see the desired document, click the "Download" button
   ![download the document](./../img/download_document.jpg)

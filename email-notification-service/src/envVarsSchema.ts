...
export const envVarsSchema = Joi.object({
  ...
  DB_TYPE: Joi.string()
    .allow("pg", "sqlite3", "mysql", "mysql2", "oracledb", "mssql", "", null)
    .empty(["", null])
    .default("pg")
    .note(
  ...
  DB_USER: Joi.string()
    ...
    .empty(["", null])
    .default("postgres")
    .note("User name for connected database."),
  DB_PASSWORD: Joi.string()
    .allow("", null)
    .empty(["", null])
    .default("test")
    .note("Password for connected database."),
  DB_HOST: Joi.string()
    .allow("", null)
    .empty(["", null])
    .default("localhost")
    .note("IP/host of connected database."),
  DB_NAME: Joi.string()
    .allow("", null)
    .empty(["", null])
  ...
  DB_PORT: Joi.number()
    ...
    .empty(["", null])
    .default(5432)
    .note("Port of connected database."),
  DB_SSL: Joi.boolean()
    .allow("", null)
    .empty(["", null])
    .default(false)
    .note("If true the DB connection is using the SSL protocol"),
  DB_SCHEMA: Joi.string()
    .allow("", null)
    .empty(["", null])
    .default("public")
    .note("Schema of connected database"),
  ...
  SMTP_PORT: Joi.number()
    ...
    .empty(["", null])
    .default(2500)
    .note("Port of external SMTP-Server."),
  ...
  RATE_LIMIT: Joi.number().optional(),

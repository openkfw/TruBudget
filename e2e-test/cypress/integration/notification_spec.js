  ...
  before(() => {
    cy.login("mstein").then(() =>
      cy
        ...
        .then(() => cy.grantProjectPermissions(projectId, "project.viewSummary", assignee))
        .then(() => cy.grantProjectPermissions(projectId, "project.viewDetails", assignee))
        .then(() => cy.grantProjectPermissions(projectId, "project.close", assignee))

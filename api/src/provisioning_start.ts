...
function mkSwaggerSchema(server: FastifyInstance) {
  return {
    ...
    schema: {
      description: "Set the provisioning status to 'start' to the systemInformation stream",
      tags: ["system"],
...
interface Service {
  startProvisioning(ctx: Ctx, user: ServiceUser): Promise<Result.Type<void>>;
}

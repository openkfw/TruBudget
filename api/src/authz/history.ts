...
const requiredPermissions = new Map<Intent, Intent[]>([
  ...
  ["project.createSubproject", ["project.viewDetails", "subproject.view"]],
  ...
  ["subproject.assign", ["subproject.view"]],
  ["subproject.update", ["subproject.view"]],

  ["subproject.createWorkflowitem", ["subproject.view", "workflowitem.view"]],
  ["subproject.reorderWorkflowitems", ["subproject.view", "workflowitem.view"]],

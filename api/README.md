...
| DOCUMENT_FEATURE_ENABLED      | no       | false         | RENAME THIS ENVAR ? If true, all uploaded documents are stored on the minio storage server. If false, the documents are stored by the multichain                                                                                                                                                                                                                                  |
| ORGANIZATION_PUBLIC_KEY       | no       | -             | Public key of the organization. This key is used to encrypt all secrets of uploaded documents (a secret is an auto-generated access-key to get access to a document that has been uploaded to minio)                                                                                                                                                                              |
| ORGANIZATION_PRIVATE_KEY      | no       | -             | Private key of the organization. This key is used to decrypt all secrets of uploaded documents (a secret is auto-generated access-key to get access to a document that has been uploaded to minio)                                                                                                                                                                                |
| STORAGE_SERVICE_HOST          | no       | localhost     | IP of connected storage service for uploading documents to minio                                                                                                                                                                                                                                                                                                                  |
| STORAGE_SERVICE_PORT          | no       | 8090          | Port of connected storage service for uploading documents to minio                                                                                                                                                                                                                                                                                                                |
| STORAGE_SERVICE_EXTERNAL_URL  | no       | localhost     | IP of connected storage service from another organization for downloading documents from minio                                                                                                                                                                                                                                                                                    |
| STORAGE_SERVICE_EXTERNAL_PORT | no       | 80            | Port of connected storage service from another organization for downloading documents from minio                                                                                                                                                                                                                                                                                  |
| ENCRYPTION_KEY                | no       | -             | Password for symmetric encryption and decryption of all data that is published to the Multichain and external storage services. The length must not be bigger than 32 characters                                                                                                                                                                                                  |

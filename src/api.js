...
export const postWorkflowItem = (stream, workflowItemName, amount, amountType, currency, purpose, documents, status, assignee, type) => axios.post('/projects/subprojects/workflows', { streamName: stream, workflowName: workflowItemName, amount, amountType, currency, purpose, documents, status, assignee, type })
export const editWorkflowItem = (stream, key, workflowItemName, amount, amountType, currency, purpose, documents, status, assignee, txid, previousState, type) => axios.post('/projects/subprojects/workflows/' + txid, { streamName: stream, key, workflowName: workflowItemName, amount, amountType, currency, purpose, documents, status, assignee, previousState, type })

...
export const editWorkflowItem = (stream, key, workflowItemName, amount, currency, purpose, addData, status, assignee, txid, previousState) => axios.post('/projects/subprojects/workflows/' + txid, { streamName: stream, key: key, workflowName: workflowItemName, amount: amount, currency: currency, purpose: purpose, addData: addData, status: status, assignee: assignee, previousState: previousState })

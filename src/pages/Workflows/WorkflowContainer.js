...
const mapDispatchToProps = (dispatch, ownProps) => {
  return {
    ...
    createWorkflowItem: (stream, workflowName, amount, amountType, currency, purpose, documents, state, assignee, workflowType) => dispatch(createWorkflowItem(stream, workflowName, amount, amountType, currency, purpose, documents, state, assignee, workflowType)),
    editWorkflowItem: (stream, key, workflowName, amount, amountType, currency, purpose, documents, state, assignee, txid, previousState, workflowType) => dispatch(editWorkflowItem(stream, key, workflowName, amount, amountType, currency, purpose, documents, state, assignee, txid, previousState, workflowType)),

...
const mapDispatchToProps = (dispatch, ownProps) => {
  return {
    ...
    editWorkflowItem: (stream, key, workflowName, amount, currency, purpose, addData, state, assignee, txid, previousState) => dispatch(editWorkflowItem(stream, key, workflowName, amount, currency, purpose, addData, state, assignee, txid, previousState)),

...
const handleSubmit = (props) => {
  if (props.editMode) {
    ...
    props.editWorkflowItem(props.location.pathname.split('/')[3], currentWorkflowItem.key, props.workflowName, props.workflowAmount, props.workflowCurrency, props.workflowPurpose, props.workflowAdditionalData, props.workflowState, props.workflowAssignee, props.workflowTxid, currentWorkflowItem.data)
  } else {

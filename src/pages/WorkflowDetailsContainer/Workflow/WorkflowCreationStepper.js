...
const getStepContent = (props) => {
  switch (props.creationStep) {
    ...
    case 5:
      return <WorkflowStateAndAssignee users={props.users} storeWorkflowState={props.storeWorkflowState} storeWorkflowAssignee={props.storeWorkflowAssignee} workflowAssignee={props.workflowAssignee} workflowState={props.workflowState} disabledWorkflowState={props.disabledWorkflowState} />
    default:
      return <span>Done</span>
  }
}

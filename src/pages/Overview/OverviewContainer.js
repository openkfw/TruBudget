...
import { fetchProjects, createProject, storeProjectName, storeProjectAmount, storeProjectComment, storeProjectCurrency, setCurrentStep, addApproverRole, addAssignmentRole, addBankRole, removeApproverRole, removeAssignmentRole, removeBankRole, storeProjectThumbnail, showProjectDialog, hideProjectDialog } from './actions';
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    removeApproverRole: (index) => dispatch(removeApproverRole(index)),
    removeAssignmentRole: (index) => dispatch(removeAssignmentRole(index)),
    removeBankRole: (index) => dispatch(removeBankRole(index)),

...
const SubProjectsTable = ({ subProjects, hideWorkflowDialog, subprojectVisible, history, location, createSubProject, subProjectName, storeSubProjectName, subProjectAmount, storeSubProjectAmount, subProjectComment, storeSubProjectComment, subProjectCurrency, storeSubProjectCurrency, showSnackBar, storeSnackBarMessage }) => {

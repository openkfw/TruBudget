    ...
    <Dialog title={strings.adminDashboard.new_user} actions={actions} modal={false} open={usersDialogShown} onRequestClose={() => hideUsersDialog()}>
      <div style={styles.container}>
        ...
        <div style={styles.textFieldDiv}>
          ...
          <AutoComplete onUpdateInput={(text) => autoCompleteUpdateInput(text, setUserRole)} errorText={showRoleNotFoundError ? strings.adminDashboard.role_not_exist_error : ""} floatingLabelText={strings.project.project_authority_role_search} searchText={role} dataSource={roles}

...
export function* editWorkflowItemSaga(action) {
  try {
    yield editWorkflowItem(action.stream, action.key, action.workflowName, action.amount, action.currency, action.purpose, action.addData, action.state, action.assignee, action.txid, action.previousState);

...
- [Getting Started](#getting-started)
  ...
  - [Starting the first TruBudget node](#starting-the-first-eep-portal-node)
  - [Working with TruBudget](#working-with-eep-portal)
  ...
  - [Using TruBudget programatically through its API](#using-eep-portal-programatically-through-its-api)
...
6e70c64c84c9        eep-portal_frontend     "/bin/sh -c '/bin/as…"   30 minutes ago      Up 30 minutes       0.0.0.0:80->80/tcp                 eep-portal_frontend_1
b6e096c65ba8        eep-portal_testapi      "/bin/sh -c 'npm sta…"   30 minutes ago      Up 30 minutes       0.0.0.0:8081->8080/tcp             eep-portal_testapi_1
8d70d9f311a9        eep-portal_api          "/bin/sh -c 'npm sta…"   30 minutes ago      Up 30 minutes       0.0.0.0:8080->8080/tcp             eep-portal_api_1
49254c50b649        eep-portal_master       "npm start"              30 minutes ago      Up 30 minutes       0.0.0.0:7447->7447/tcp, 8000/tcp   eep-portal_master_1
0b458b72d14f        eep-portal_testmaster   "npm start"              30 minutes ago      Up 30 minutes       8000/tcp, 0.0.0.0:7448->7447/tcp   eep-portal_testmaster_1
```

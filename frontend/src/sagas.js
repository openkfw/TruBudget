...
export function* validateDocumentSaga({ base64String, hash, projectId, subprojectId, workflowitemId }) {
  yield execute(function*() {
    const { data } = yield callApi(api.validateDocument, base64String, hash, projectId, subprojectId, workflowitemId);
    yield put({

...
import {
  ...
  FETCH_PROJECT_PERMISSIONS_SUCCESS, GRANT_PROJECT_PERMISSION_FAILURE, GRANT_PROJECT_PERMISSION_SUCCESS, REVOKE_PROJECT_PERMISSION_FAILURE, REVOKE_PROJECT_PERMISSION_SUCCESS
} from "../Overview/actions";
import {
  ASSIGN_PROJECT_FAILURE, ASSIGN_PROJECT_SUCCESS, CLOSE_PROJECT_FAILURE, CLOSE_PROJECT_SUCCESS, CREATE_SUBPROJECT_FAILURE, CREATE_SUBPROJECT_SUCCESS, FETCH_SUBPROJECT_PERMISSIONS,
  FETCH_SUBPROJECT_PERMISSIONS_FAILURE, FETCH_SUBPROJECT_PERMISSIONS_SUCCESS, GRANT_SUBPROJECT_PERMISSION_FAILURE, GRANT_SUBPROJECT_PERMISSION_SUCCESS, REVOKE_SUBPROJECT_PERMISSION_FAILURE, REVOKE_SUBPROJECT_PERMISSION_SUCCESS
} from "../SubProjects/actions";
import { DISABLE_USER_FAILURE, DISABLE_USER_SUCCESS, ENABLE_USER_FAILURE, ENABLE_USER_SUCCESS } from "../Users/actions";
import {
  ASSIGN_SUBPROJECT_FAILURE, ASSIGN_SUBPROJECT_SUCCESS, ASSIGN_WORKFLOWITEM_FAILURE, ASSIGN_WORKFLOWITEM_SUCCESS, CLOSE_SUBPROJECT_FAILURE, CLOSE_SUBPROJECT_SUCCESS, CLOSE_WORKFLOWITEM_FAILURE, CLOSE_WORKFLOWITEM_SUCCESS, CREATE_WORKFLOW_FAILURE, CREATE_WORKFLOW_SUCCESS, FETCH_WORKFLOWITEM_PERMISSIONS,
  FETCH_WORKFLOWITEM_PERMISSIONS_FAILURE, FETCH_WORKFLOWITEM_PERMISSIONS_SUCCESS, GRANT_WORKFLOWITEM_PERMISSION_FAILURE, GRANT_WORKFLOWITEM_PERMISSION_SUCCESS, REJECT_WORKFLOWITEM_FAILURE, REVOKE_WORKFLOWITEM_PERMISSION_FAILURE, REVOKE_WORKFLOWITEM_PERMISSION_SUCCESS
} from "../Workflows/actions";
import {
  ACTION_UPDATE_REQUIRED,
  CONFIRMATION_CANCELLED, CONFIRMATION_CLOSE, CONFIRMATION_CONFIRMED,
  CONFIRMATION_FINISHED, CONFIRMATION_REQUIRED,
  ...
  EXECUTING_ORIGINAL_ACTIONS_SUCCESS, STORE_ACTIONS,
  STORE_POST_ACTIONS,
...
export default function confirmationReducer(state = defaultState, action) {
  switch (action.type) {
    ...
    case CONFIRMATION_FINISHED:
      return defaultState.set("confirmationFinished", true);
    ...
    case REJECT_WORKFLOWITEM_FAILURE:

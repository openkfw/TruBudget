...
import { fetchSubProjectPermissions, hideSubProjectPermissions, grantSubProjectPermission, fetchWorkflowItemPermissions, grantWorkflowItemPermission, hideWorkflowItemPermissions } from './actions';
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    grantPermission: (pId, wId, permission, user) => dispatch(grantWorkflowItemPermission(pId, wId, permission, user, true)),
    fetchWorkflowItemPermissions: (pId, wId, showLoading) => dispatch(fetchWorkflowItemPermissions(pId, wId, showLoading)),

                  ...
                  {convertedTotalBudget.map((budget) => (
                    <TableRow key={budget.organization + budget.currencyCode}>
                      ...
                      <TableCell align="right">
                        {budget?.value === 0 || budget?.value === "0" ? "" : this.convertToSelectedCurrency(1, budget.currencyCode).toFixed(4)}
                      </TableCell>
                      <TableCell align="right">{toAmountString(budget.convertedAmount, indicatedCurrency, true)}</TableCell>
                    </TableRow>
                  ))}
                  <TableRow>
                    <TableCell />

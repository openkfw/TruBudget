const ka = {
  ...
  common: {
    ...
    history: "ისტორია",
    workflowitem_history: "Workflow action ისტორია",
  ...
  subproject: {
    ...
    subproject_close_info: "workflow action-ი დახურული არ არის",
    subproject_close_not_allowed: "თქვენ არ გაქვთ უფლებამოსილება დახუროთ ქვეპროექტი",
    subproject_comment: "სუბტიტრები",
    ...
    subproject_general_workflowitem_type: "დაუშვით მხოლოდ workflow action ტიპის ზოგადი",
  ...
  workflow: {
    add_item: "Workflow action-ის შექმნა",
    add_tag_wfi_text: "ტეგის დამატება",
    approval_required: "აუცილებელია დადასტურება",
    assignee: "პასუხისმგებელი",
    search_text: "სამუშაო პროცესის მოქმედებების ძიება",
    edit_item: "Workflow action-ის რედაქტირება",
    exit_sort_mode:
    ...
    workflow_none: "None",
    workflow_permissions_title: "Workflow action-თან დაკავშირებით უფლებამოსილების მინიჭება",
    workflow_redacted: "Redacted",
    workflow_reject_reason: "უარყავი მიზეზი",
    workflow_selection: "{0} Workflow action-ები არჩეულია",
    ...
    workflow_table_title: "Workflow action-ები",
    workflow_title_description: "Workflow action-ის სახელწოდება",
    workflow_title: "Workflow action-ის სათაური",
    workflow_type_transaction: "ტრანზაქცია",
    workflow_type_workflow: "Workflow action-ი",
    workflow_type: "Type",
    ...
    workflowitem_details: "Workflow action-ის დეტალები",
  ...
  intents: {
    ...
    createWorkflowitem: "Workflow action-ის შექმნა",
    grantPermission: "უფლებამოსილების მინიჭება",
    listPermissions: "უფლებამოსილების ნახვა",
    reorderWorkflowitems: "Workflow action-ების რიგითობის შეცვლა",
  ...
  notification: {
    ...
    create_workflow: "Workflow action-ი {0} შექმნილია",
    done_transaction: " ტრანზაქციის {0} სტატუსი შეიცვალა და დასრულებულია",
    done_workflow: "Workflow action-ის {0} სტატუსი შეიცვალა და დასრულებულია",
    edit_transaction: "ტრანზაქცია {0} რედაქტირებულია",
    edit_workflow: "Workflow action-ი {0} რედაქტირებულია",
    ...
    review_workflow: "Workflow action-ი {0} გადმოგეგზავნათ განსახილველად",
    ...
    subproject_createWorkflowitem: "ქვეპროექტისთვის {0} ახალი workflow action-ი შეიქმნა",
    ...
    subproject_reorderWorkflowitems: "ქვეპროექტის {0} workflow action-ების რიგითობა შეცვლილია",
    subproject_update: "ქვეპროექტი {0} განახლებულია",
    subproject_updated: "ქვეპროექტი {0} განახლებულია",
    workflowitem_assign: "Workflow action-ი {0} გადმოგეგზავნათ განსახილველად",
    workflowitem_assigned: "Workflow action-ი {0} გადმოგეგზავნათ განსახილველად",
    workflowitem_close: "Workflow action-ი {0} დახურულია",
    workflowitem_closed: "Workflow action-ი {0} დახურულია",
    workflowitem_intent_grantPermission: "Workflow action-ის {0} ნებართები შეცვლილია",
  ...
  history: {
    edit_currency: "Workflow action-ის {0} ვალუტა შეიცვალა და გახდა {1} ",
    edit_documents: "Workflow action-ისთვის {0} შეიცვალა დოკუმენტები ",
    edit_status: "Workflow action-ის {0} სტატუსი შეიცვალა და გახდა {1}",
    edit_subproject: "თანხა გაიზარდა {0}-დან {1}-მდე",
    edit_workflowName: "Workflow action-ის {0} სახელწოდება შეიცვალა და გახდა {1} ",
    ...
    subproject_createWorkflowitem: "{0} შექმნა workflow action-ი {1}",
    ...
    to: "{0} to {1}",
    workflowitem_assign: "{0} მიანიჭა {2}-ს workflow action-ი {1}",
    workflowitem_close: "{0} დახურა workflow action-ი {1}",
    ...
    workflowitem_update_docs: "{0} დაამატა დოკუმენტები workflow action-ს {1} ",
    workflowitem_delete_docs: "{0} წაშლილი დოკუმენტები სამუშაო პროცესიდან {1}",
    workflowitem_update: "{0} შეცვალა workflow action-ი {1} ",
    workflowitem_update_amount: "{0} შეცვალა workflow action-ი {1} ბიუჯეტი წელს {2}",
    workflowitem_document_validated: "{0} დადასტურებულია workflow action სისტემაში მითითებული დოკუმენტ {1} ი {2} ",
  ...
  permissions: {
    ...
    subproject_createWorkflowitem: "შექმენით workflow action-ები",
    subproject_intent_grantPermission: "მიანიჭეთ workflow action-ების ნებართვები",
    ...
    subproject_reorderWorkflowitems: "გადააჯგუფეთ workflow action-ები",
    ...
    workflowitem_assign: "გადაუგზავნეთ სხვებს workflow action-ი განსახილველად",
    workflowitem_close: "დახურეთ workflow action-ი",
  ...
  eventTypes: {
    ...
    workflowitem_document_validated: "Workflow action დოკუმენტი დადასტურებულია",
    workflowitem_updated: "Workflow action განახლებულია",
    workflowitem_assigned: "სამუშაო გრაფიკი დაევალა",
    workflowitem_closed: "Workflow action დახურულია",
    workflowitem_permission_granted: "მიენიჭა workflow action ნებართვა",
    workflowitem_permission_revoked: "სამუშაო პროცესის ნებართვა გაუქმებულია",
    workflowitems_reordered: "Workflow actions გადაკეთდა"
  },

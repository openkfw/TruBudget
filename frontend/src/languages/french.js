const fr = {
  ...
  notification: {
    ...
    subproject_assigned: "Sous-projet {0} vous a été assigné",
    subproject_close: "Sous-projet {0} a été fermé",
    subproject_closed: "Sous-projet {0} a été fermé",
    ...
    subproject_updated: "Sous-projet {0} a été actualisé",
  ...
  history: {
    ...
    project_createSubproject: "{0} a crée sous-projet {1}",
    ...
    subproject_close: "{0} a terminé le sous-projet {1}",
    ...
    subproject_update: "{0} a modifié le sous-projet {1} ",
    to: "{0} à {1}",

const fr = {
  ...
  users: {
    ...
    privacy_notice:
      "Assurez-vous de ne pas fournir d'informations personnelles (nom, prénom(s), matricule, adresse mail) en remplissant ce formulaire. En cliquant sur \"SOUMETTRE\" vous nous autorisez à sauvegarder vos données de façon permanente et vous confirmez d'avoir lu le présent avis de confidentialité.",
  ...
  analytics: {
    assigned_budget_ratio: "Taux d’allocation budgétaire(engagé/prévu)",

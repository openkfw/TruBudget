...
const fr = {
  ...
  permissions: {
    ...
    "project.createSubproject": 'French: Create subprojects',
    "subproject.archive": 'French: Archive subproject',
    "subproject.assign": 'French: Assign subproject',
    "subproject.close": 'French: Close subproject',
    "subproject.createWorkflowitem": 'French: Create workflow items',
    "subproject.intent.grantPermission": 'French: Grant subproject permissions',
    "subproject.intent.listPermissions": 'French: View subproject permissions',
    "subproject.intent.revokePermission": 'French: Revoke subproject permissions',

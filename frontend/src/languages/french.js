const fr = {
  ...
  users: {
    ...
    assigned_message:
      "Avant de désactiver cet utilisateur, veuillez lui retirer ses responsabilités sur les éléments suivants:",
  ...
  analytics: {
    ...
    disbursed_budget_ratio: "Taux de paiement(payé/alloué)",

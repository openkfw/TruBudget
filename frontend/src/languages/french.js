const fr = {
  ...
  common: {
    ...
    history: "Historique",
    workflowitem_history: "Historique des étapes de workflow action",
    ...
    no_documents_info_text: "Vous pouvez modifier l'étape de workflow action pour ajouter des documents",
    ...
    no_workflow_items: "Aucune étape de workflow action ",
    ...
    workflowitem: "Étape de workflow action",
  ...
  subproject: {
    assignee: "Créateur",
    fixed_workflowitem_type: "Type de workflow action fixe",
    ...
    subproject_close_info: "Au moins une étape de workflow action n'est pas encore fermée",
    subproject_close_not_allowed: "Vous n'êtes pas autorisé à fermer la composante",
    subproject_comment: "Sous-titre",
    ...
    subproject_any_workflowitem_type:
      "Autoriser les éléments de workflow action à sélectionner un type général ou restreint",
    subproject_general_workflowitem_type: "Autoriser uniquement les éléments de workflow action de type général",
  ...
  workflow: {
    add_item: "Creer une étape de workflow action",
    add_tag_wfi_text: "Ajouter un tag sur l’étape de workflow action",
    approval_required: "Approbation exigée",
    assignee: "Responsable",
    edit_item: "Modifier l'étape de workflow action",
    exit_sort_mode:
      "Ce bouton est désormais désactivé. Quitter le mode de tri pour créer de nouveaux éléments de workflow action",
    exchange_rate: "taux de change",
    search_text: "Rechercher des actions de flux de travail",
    ...
    workflow_comment: "Commentaire sur l’étape de workflow action",
    ...
    workflow_documents: "Documents de l’étape de workflow action",
    workflow_documents_add_file: "Ajouter un fichier",
    workflow_documents_add_link: "Ajouter un lien externe",
    workflow_documents_file_prepared: "Dossier préparé",
    workflow_documents_upload_same_document: "Téléchargez le même document pour créer un hachage",
    workflow_documents_link_url: "Lien externe URL",
    workflow_documents_link_name: "Nom du document externe",
    workflow_documents_size_exceed: "La taille du fichier dépasse la limite de",
    workflow_documents_upload_heading: "Télécharger le document",
    workflow_enable_sort: "Trier",
    workflow_fingerprint: "Empreinte digitale",
    workflow_name: "Nom de l’étape de workflow action",
    workflow_next_step: "Prochaine étape",
    workflow_no_actions: "Pas d'action",
    workflow_no_documents: "Pas de document",
    workflow_none: "blub",
    workflow_permissions_title: "Définir les autorisations sur l'étape de workflow action",
    workflow_redacted: "Expurgé",
    workflow_reject_reason: "Motif de rejet",
    workflow_selection: "Vous avez sélectionné {0} étapes de workflow action ",
    workflow_selection_copy_description:
      "Cette fonctionnalité vous permet de copier tous les éléments de workflow action sélectionnés vers le sous-projet de destination, y compris les montants et les personnes affectées. Les éléments de flux de travail copiés seront en statut ouvert et vous pourrez donc les modifier par la suite.",
    ...
    workflow_title_description: "Description du titre de l’étape de workflow action",
    workflow_title: "Titre de l’étape de workflow action",
    workflow_type_transaction: "Transaction",
    workflow_type_workflow: "Workflow action",
    workflow_type: "Type du Workflow action",
    ...
    workflowitem_details: "Détails de l’étape du workflow action",
  ...
  users: {
    ...
    not_assigned_message:
      "Cet utilisateur n'est affecté à aucun projet, composante et étape de workflow action et peut être désactivé",
  ...
  confirmation: {
    ...
    workflowitem_close: "Fermer l’étape de workflow action ",
    workflowitem_close_text: "Êtes-vous sûr de vouloir fermer cette étape de workflow action?",
    workflowitem_create: "créer des étapes de workflow action",
  ...
  intents: {
    ...
    createWorkflowitem: "créer des étapes de workflow action",
    grantPermission: "accorder autorisations",
    listPermissions: "voir autorisations",
    reorderWorkflowitems: "réorganiser les étapes de workflow action",
  ...
  notification: {
    ...
    create_workflow: "Workflow action {0} créé",
    done_transaction: "L'état de la transaction {0} est défini sur Terminé",
    done_workflow: "L'état du Workflow action {0} est défini sur terminé",
    edit_transaction: "Transaction {0} actualisée",
    edit_workflow: "Workflow action {0} actualisée",
    ...
    review_workflow: "Vous êtes assigné à examiner l’étape de workflow action {0}",
    ...
    subproject_createWorkflowitem: "Une nouvelle étape de workflow action a été créée pour la composante {0}",
  ...
  history: {
    edit_currency: "La devise de l’étape de workflow action {0} a changé pour {1} ",
    edit_documents: "Documents modifiés pour l’étape de workflow action {0}",
    edit_status: "L'état de l’étape de workflow action {0} a changé pour {1} ",
    edit_subproject: "Montant de {0} augmenté à {1}",
    edit_workflowName: "Nom de l’étape de workflow action {0} modifié à {1} ",
    ...
    subproject_createWorkflowitem: "{0} a crée l’étape de workflow action {1}",
    ...
    to: "{0} à {1}",
    workflowitem_assign: "{0} a assigné l’étape de workflow action {1} à {2}",
    workflowitem_close: "{0} a terminé l’étape de workflow action {1}",
    ...
    workflowitem_update_docs: "{0} a ajouté des documents au workflow action {1} ",
    workflowitem_delete_docs: "{0} a supprimé des documents du workflow action {1} ",
    workflowitem_update: "{0} a modifié le workflow action {1} ",
    workflowitem_update_amount: "{0} a modifié le workflow action {1} budget dans {2}",
    ...
    workflowitem_document_invalidated:
      "{0} a utilisé un document différent dans le workflow action pour valider le document nommé avec {1} dans {2} "
  },
  ...
  permissions: {
    ...
    subproject_close: "Fermer la composante",
    subproject_createWorkflowitem: "Créer des étapes de workflow action",
    ...
    subproject_reorderWorkflowitems: "Réorganiser les étapes de workflow action",
    ...
    workflowitem_assign: "Assigner l’étape de workflow action",
    workflowitem_close: "Fermer l’étape de workflow action",
  ...
  eventTypes: {
    ...
    workflowitem_created: " Étape de workflow action créée",
    workflowitem_document_validated: "Document workflow action validé",
    workflowitem_updated: " Étape de workflow action mise à jour",
    workflowitem_assigned: " Étape de workflow action assignée",
    workflowitem_closed: " Étape de workflow action fermée",
    ...
    workflowitems_reordered: " Étapes de workflow action réorganisées"
  },

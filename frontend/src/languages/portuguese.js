const pt = {
  ...
  project: {
    ...
    project_permissions_title: "Pt: Set permissions for project"
  },
  subproject: {
    ...
    subproject_permissions_title: "Pt: Set permissions for subproject"
  },
  workflow: {
    ...
    workflow_permissions_title: "Pt: Set permissions for workflowitem",
    workflow_redacted: "Pt: redacted"
  },
  ...
  permissions: {
    ...
    project_assign: "Pt: Assign project to others",
    project_intent_grantPermission: "Pt: Grant permissions",
    project_intent_listPermissions: "Pt: View permissions",
    project_intent_revokePermission: "Pt: Revoke permissions",
    project_viewDetails: "Pt: View project details",
    project_viewSummary: "Pt: View project in overview",
    project_createSubproject: "Pt: Create subprojects",
    subproject_archive: "Pt: Archive subproject",
    subproject_assign: "Pt: Assign subproject",
    subproject_close: "Pt: Close subproject",
    subproject_createWorkflowitem: "Pt: Create workflow items",
    subproject_intent_grantPermission: "Pt: Grant subproject permissions",
    subproject_intent_listPermissions: "Pt: View subproject permissions",
    subproject_intent_revokePermission: "Pt: Revoke subproject permissions",
    subproject_update: "Pt: Update subproject",
    subproject_viewDetails: "Pt: View subproject details",
    subproject_viewSummary: "Pt: View subproject overview",
    workflowitem_intent_listPermissions: "Pt: Show workflowitem permissions",
    workflowitem_intent_grantPermission: "Pt: Grant workflowitem permission",
    workflowitem_intent_revokePermission: "Pt: Revoke workflowitem permission",
    workflowitem_view: "Pt: View workflowitem",
    workflowitem_assign: "Pt: Assign workflowitem",
    workflowitem_update: "Pt: Update workflowitem",
    workflowitem_close: "Pt: Close workflowitem",
    workflowitem_archive: "Pt: Archive workflowitem"
  },
  language: {
    german: "German",
    french: "Français",

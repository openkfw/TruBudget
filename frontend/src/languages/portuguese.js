const pt = {
  ...
  common: {
    ...
    history: "Histórico",
    workflowitem_history: "História do item de workflow action",
    ...
    no_documents_info_text: "Você pode editar o item de workflow action de trabalho para adicionar documentos",
    ...
    no_workflow_items: "Nenhum itens de workflow action encontrado",
    ...
    workflowitem: "Item de workflow action",
  ...
  users: {
    ...
    assigned_workflowitems: "Assigned workflow actions",
  ...
  workflow: {
    add_item: "Criar item de workflow action",
    add_tag_wfi_text: "Adicionar tag a item de workflow action",
    approval_required: "Aprovação necessária",
    assignee: "Responsável",
    edit_item: "Editar item de workflow action",
    exit_sort_mode:
    ...
    workflow_comment: "Comentário do item de workflow action",
    ...
    workflow_permissions_title: "Configurar permissões para item de workflow action",
    workflow_redacted: "Editado por privacidade",
    workflow_reject_reason: "Rejeitar a razão",
    workflow_selection: "Você selecionaou {0} itens de workflow actions",
    ...
    workflow_table_title: "Lista de itens de workflow action",
    workflow_title_description: "Descrição do item de workflow action",
    workflow_title: "Nome do item de workflow action",
    ...
    workflowitem_details: "Detalhes do item de workflow action",
  ...
  confirmation: {
    ...
    post_actions_dialog_text: "Tem certeza de que deseja criar o workflow action action",
    ...
    workflowitem_close: "Fechar item de workflow action",
  ...
  intents: {
    ...
    createWorkflowitem: "criar items de workflow action",
    grantPermission: "conceder permissões",
    listPermissions: "ver permissões",
    reorderWorkflowitems: "reordenar  items de workflow action",
  ...
  notification: {
    ...
    create_workflow: "Item de workflow action {0} criado ",
    done_transaction: "Status da transação {0} alterado para Finalizado",
    done_workflow: "Status do item de workflow action {0} alterado para Finalizado",
    edit_transaction: "Transação {0} foi adaptada ",
    edit_workflow: "Item de workflow action {0} foi adaptado ",
    ...
    review_workflow: "Você foi solicitado a revisar o item de workflow action {0}",
    ...
    subproject_createWorkflowitem: "Um novo item de workflow action foi criado para o subprojeto {0}",
    ...
    subproject_reorderWorkflowitems: "Os items de workflow action do subprojeto {0} foram reordenados",
    subproject_update: "Subprojeto {0} foi atualizado",
    subproject_updated: "Subprojeto {0} foi atualizado",
    workflowitem_assign: "Item de workflow action {0} foi atribuído a você",
    workflowitem_assigned: "Item de workflow action {0} foi atribuído a você",
    workflowitem_close: "Item de Workflow action {0} foi fechado",
    workflowitem_closed: "Item de Workflow action {0} foi fechado",
    workflowitem_intent_grantPermission: "As permissões para o item de workflow action {0} foram alteradas",
  ...
  history: {
    edit_currency: "Moeda do workflow action {0} mudou para {1} ",
    edit_documents: "Documentos alterados para workflow action {0}",
    edit_status: "Status do workflow action {0} mudou para {1}",
    edit_subproject: "Valor de {0} subiu para {1}",
    edit_workflowName: "Nome do item de workflow action {0} mudou para {1} ",
    end_date: "data final",
    ...
    subproject_createWorkflowitem: "{0} criou item de workflow action {1}",
    ...
    subproject_reorderWorkflowitems: "{0} alterou a ordem dos items de workflow action",
    ...
    to: "{0} para {1}",
    workflowitem_assign: "{0} atribuiu item de workflow action {1} para {2}",
    workflowitem_close: "{0} fechou item de workflow action {1}",
    ...
    workflowitem_update_docs: "{0} adicionou documentos ao item de workflow action {1} ",
    workflowitem_delete_docs: "{0} excluiu documentos do item de workflow action {1} ",
    workflowitem_update: "{0} modificou o item de workflow action {1} ",
    workflowitem_update_amount: "{0} modificou o item de workflow action {1} despesas dentro {2} ",
  ...
  permissions: {
    ...
    subproject_createWorkflowitem: "Criar item de workflow action",
    ...
    subproject_reorderWorkflowitems: "Reordenar items de workflow action",
    ...
    workflowitem_assign: "Atribuir item de workflow action a outros",
    workflowitem_close: "Fechar item de workflow action",
  ...
  eventTypes: {
    ...
    workflowitem_created: "Workflow action criado",
    workflowitem_document_validated: "Documento de item de fluxo de trabalho validado",
    workflowitem_updated: "Workflow action actualizado",
    workflowitem_assigned: "Workflow action assigned",
    workflowitem_closed: "Workflow action encerrado",
    workflowitem_permission_granted: "Workflow action permisision granted",

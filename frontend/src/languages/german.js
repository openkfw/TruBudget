const de = {
  ...
  common: {
    ...
    hash: "Hash",
    history: "Historie",
    workflowitem_history: "Workflow action Historie",
  ...
  subproject: {
    assignee: "Ersteller",
    fixed_workflowitem_type: "Fester Workflow action Typ",
    ...
    subproject_close_info: "Mindestens ein Workflow action wurde noch nicht geschlossen",
    ...
    subproject_any_workflowitem_type: "Workflow actions erlauben, allgemeinen oder eingeschränkten Typ auszuwählen",
  ...
  workflow: {
    add_item: "Workflow action erstellen",
    add_tag_wfi_text: "Tag zum Workflow action hinzufügen",
    approval_required: "Bestätigung benötigt",
    assignee: "Verantwortlicher",
    edit_item: "Workflow action ändern",
    exit_sort_mode:
    ...
    workflow_documents_file_prepared: "Datei vorbereitet",
    workflow_documents_upload_same_document: "Laden Sie dasselbe Dokument hoch, um einen Hash zu erstellen",
    workflow_documents_link_url: "Externer Link URL",
    workflow_documents_link_name: "Externer Dokumentname",
    workflow_documents_size_exceed: "Die Dateigröße überschreitet das Limit von",
    workflow_documents_upload_heading: "Dokument hochladen",
    ...
    workflow_none: "Keine",
    workflow_permissions_title: "Setze Berechtigungen für das Workflow action",
    ...
    workflow_title_description: "Name des Workflow actions",
  ...
  users: {
    ...
    assigned_workflowitems: "Zugewiesene Workflow actions",
    assigned_message:
      "Vor dem Deaktivieren muss für diesen Benutzer die Zuordnung zu folgenden Elementen aufgehoben werden",
    not_assigned_message:
      "Dieser Benutzer ist keinem Projekt, Subprojekt und Workflow action zugeordnet und kann deaktiviert werden.",
  ...
  confirmation: {
    ...
    post_actions_dialog_text: "Nach Erstellung des Workflow actions werden folgende Aktionen ausgeführt",
    ...
    workflowitem_close: "Workflow action schließen",
    workflowitem_close_text: "Sind Sie sicher, dass Sie dieses Workflow-Item schließen wollen?",
    workflowitem_create: "Erstelle Workflow action",
  ...
  intents: {
    ...
    createWorkflowitem: "Workflow actions erstellen",
    grantPermission: "Berechtigungen vergeben",
    listPermissions: "Berechtigungen anzeigen",
    reorderWorkflowitems: "Workflow action neu anordnen",
  ...
  analytics: {
    ...
    insufficient_permissions_text:
      "Ein oder mehrere Workflow actions sind zensiert. Die Analysen werden ausgeblendet, weil sie verfälscht würden.",
  ...
  notification: {
    ...
    edit_workflow: "Workflow action {0} wurde angepasst",
    ...
    subproject_createWorkflowitem: "Für Subprojekt {0} wurde ein neues Workflow action erstellt",
    ...
    subproject_reorderWorkflowitems: "Die Workflow actions des Subprojekts {0} wurden neu geordnet",
    subproject_update: "Subprojekt {0} aktualisieren",
    subproject_updated: "Subprojekt {0} wurde aktualisiert",
    workflowitem_assign: "Workflow action {0} wurde Ihnen zugewiesen",
    workflowitem_assigned: "Workflow action {0} wurde Ihnen zugewiesen",
    workflowitem_close: "Workflow action {0} wurde geschlossen",
    workflowitem_closed: "Workflow action {0} wurde geschlossen",
    workflowitem_intent_grantPermission: "Die Berechtigungen für Workflow action {0} wurden geändert",
  ...
  history: {
    edit_currency: "Die Währung des Workflow actions {0} wurde zu {1} geändert ",
    edit_documents: "Dokumente für Workflow action {0} geändert",
    edit_status: "Status von Workflow action {0} wurde auf {1} geändert",
    ...
    workflowitem_update_docs: "{0} fügte Dokumente zu Workflow action {1} hinzu",
    workflowitem_delete_docs: "{0} löschte Dokumente von Workflow action {1}",
    workflowitem_update: "{0} veränderte Workflow action {1} ",
    workflowitem_update_amount: "{0} veränderte Workflow action {1} Budget in {2} ",
    workflowitem_document_validated: "{0} validiertes Workflow action-Dokument mit dem Namen {1} in {2} ",
    workflowitem_document_invalidated:
      "{0} hat ein anderes Dokument im Workflow action verwendet, um das mit benannte Dokument zu validieren {1} in {2} ",
    end_date: "Enddatum",
    ...
    to: "{0} bis {1}",
    workflowitem_assign: "{0} zugewiesenes Workflow action {1} an {2}",
    workflowitem_close: "{0} geschlossenes Workflow action {1}",
    ...
    subproject_createWorkflowitem: "{0} erstellte Workflow action {1}",
    subproject_reorderWorkflowitems: "{0} changed the workflow action ordering"
  },
  ...
  permissions: {
    ...
    subproject_close: "Subprojekt schließen",
    subproject_createWorkflowitem: "Workflow actions erstellen",
    ...
    workflowitem_assign: "Workflow action zuweisen",
    workflowitem_close: "Workflow action schließen",
  ...
  eventTypes: {
    ...
    workflowitem_created: "Workflow action erzeugt",
    workflowitem_document_validated: "Workflow action-Dokument validiert",
    workflowitem_updated: "Workflow action aktualisiert",
    workflowitem_assigned: "Workflow action zugeordnet",
    workflowitem_closed: "Workflow action geschlossen",
    workflowitem_permission_granted: "Workflow action-Erlaubnis erteilt",
    workflowitem_permission_revoked: "Workflow action-Erlaubnis widerrufen",

...
class Api {
  ...
  validateDocument = (base64String, hash, projectId, subprojectId, workflowitemId) => instance.post(`/workflowitem.validateDocument`, { base64String, hash, projectId, subprojectId, workflowitemId });

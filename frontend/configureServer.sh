...
sed -i 's/REACT_APP_AUTHBUDDY_ENABLED: "false"/REACT_APP_AUTHBUDDY_ENABLED: "'$REACT_APP_AUTHBUDDY_ENABLED'"/g' ${INJECT_FILE_PATH}
sed -i 's/REACT_APP_AUTHBUDDY_URL: "localhost"/REACT_APP_AUTHBUDDY_URL: "'$REACT_APP_AUTHBUDDY_URL'"/g' ${INJECT_FILE_PATH}
